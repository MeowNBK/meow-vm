...
class Value {
   ...
   public:
    ...
    [[nodiscard]] inline bool is_bound_method() const noexcept {
        return data_.holds<bound_method_t>();
    }
    ...
    [[nodiscard]] inline bound_method_t as_bound_method() const noexcept {
        return data_.get<bound_method_t>();
    }
    ...
    //         std::is_base_of_v<meow::core::MeowObject,
    //         std::remove_pointer_t<T>>) return arg; return nullptr;
    //     });
    // }
